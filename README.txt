...
When GosuMemory! launches, launch osu! Auto Deafen right after. Be sure to configure your username in settings.json CORRECTLY before
running the program.

- Syntax rules for settings.json:
-- Make sure that usernames, words, etc. are within the quotation marks. ("") 
-- DO NOT DELETE ANY COMMAS
